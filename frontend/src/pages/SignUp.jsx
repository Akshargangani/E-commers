...
import loginIcons from '../assest/assets/signin.gif'
...
const SignUp = () => {
  ...
  const handleSubmit = async(e) =>{
      ...
      if(data.password === data.confirmPassword){
        ...
        try {
          // Mock signup for demonstration - in real app, this would be an API call
          if (data.name && data.email && data.password) {
            // Mock user data
            const userData = {
              _id: Date.now().toString(),
              firstName: data.name.split(' ')[0] || 'Akshar',
              lastName: data.name.split(' ')[1] || 'Name',
              email: data.email,
              role: 'user',
